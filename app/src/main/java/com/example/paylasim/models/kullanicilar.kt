...
class kullanicilar {
    ...
    constructor(
        ...
        user_id: String?,
        user_detail: kullaniciDetaylari?
    ) {
        this.email = email
    ...
    override fun toString(): String {
        return "kullanicilar(email=$email, password=$password, user_name=$user_name, adi_soyadi=$adi_soyadi, phone_number=$phone_number, email_phone_number=$email_phone_number, user_id=$user_id, user_detail=$user_detail)"
    }
