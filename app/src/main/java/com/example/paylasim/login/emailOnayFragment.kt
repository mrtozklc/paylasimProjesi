                    ...
                    override fun onDataChange(snapshot: DataSnapshot) {
                        ...
                        if (snapshot!!.getValue() != null) {
                            ...
                            if (!userNameKullanimdaMi) {
                                        ...
                                        .addOnCompleteListener(object : OnCompleteListener<AuthResult> {
                                            override fun onComplete(p0: Task<AuthResult>) {
                                                ...
                                                if (p0!!.isSuccessful) {
                                                    ...
                                                    var kaydedilecekKullaniciDetaylari=kullaniciDetaylari("0","0","0","","","")
                                ...
                                //kulllanıcı telefon no ile kayıt
                                else {

                                    var sifre = view.etSifre.text.toString()
                                    var sahteEmail = telNo + "@fake.com"
                                    var adSoyad = view.etAdSoyad.text.toString()
                                    var userName = view.etKullaniciAdi.text.toString()
                                    auth.createUserWithEmailAndPassword(sahteEmail, sifre)
                                        .addOnCompleteListener(object : OnCompleteListener<AuthResult> {
                                            override fun onComplete(p0: Task<AuthResult>) {
                                                ...
                                                if (p0!!.isSuccessful) {
                                                    ...
                                                    //oturum açan kullanıcı bilgileri database

                                                    var kaydedilecekKullaniciDetaylari=kullaniciDetaylari("0","0","0","","","")


                                                    var kaydedilecekKullanici = kullanicilar("", sifre, userName, adSoyad, telNo, sahteEmail, userID,kaydedilecekKullaniciDetaylari)
